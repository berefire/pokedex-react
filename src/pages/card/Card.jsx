  ...
  return (
    <div className={css.card}>
      ...
      >
        ...
        <h4 className={css.altura_pokemon}> Altura: {itemPokemon.height}0 cm </h4>
        <h4 className={css.peso_pokemon}>Peso: {itemPokemon.weight} Kg </h4>
        <h4 className={css.habitat_pokemon}>
